...
knitr::include_graphics("/Users/claregaffey/Documents/RClass/asc346/images/trend_tests.png")
```
...
ppath <- "/Users/claregaffey/Documents/RClass/hcdc.mon.mean.nc" #(Clare's path)
# (Aandishah's path) C:/Users/aandi/Desktop/Fall_2021/GEOG_399/Datasets/hcdc.mon.mean.nc"
...
knitr::include_graphics("/Users/claregaffey/Documents/RClass/asc346/images/boxplot.png")
```
...
ppath <- "/Users/claregaffey/Documents/RClass/"
ncpath <- ppath
...
```{r,  warning = FALSE, echo = FALSE, message = FALSE, out.height = 300, out.width = 350}

#!!!!!!NEED TO ADD THE PNG
# b <- raster::brick(s3url)[[4:2]]
library(png)
#png(here::here("inst/hcdc2021_09.png"), height = 4,
 #   width = 4, units  = "in", res = 300, bg = "transparent")
 #raster::plot(b, stretch = "lin")
 #dev.off()

knitr::include_graphics("/Users/claregaffey/Documents/RClass/asc346/images/hcdc2021_09.png")
...
knitr::include_graphics("/Users/claregaffey/Documents/RClass/asc346/images/timeline.png")
```
